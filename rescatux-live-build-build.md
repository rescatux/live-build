...
docker run \
  ...
  -v /dev:/dev \
  -v $(pwd):/live-build-repo:ro \
  -v $(pwd)/releases:/live-build-build/releases:rw \
  -v $(pwd)/news-releases:/live-build-build/news-releases:rw \
  -v $(pwd)/secureboot-binaries:/live-build-build/secureboot-binaries:rw \
  -v $(pwd)/secureboot.d/sha256sums:/live-build-build/secureboot.d/sha256sums:rw \
  live-build-manual-builder:latest
```
